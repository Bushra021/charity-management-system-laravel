...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | تحتوي الأسطر اللغوية التالية على رسائل الأخطاء الافتراضية المستخدمة من قبل
    ...
    */
    ...
    | اصطلاح "attribute.rule" لتسمية الأسطر. هذا يجعل من السريع
    | تحديد سطر لغة مخصص لخاصية معينة.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | الأسطر اللغوية التالية تستخدم لاستبدال العنصر النائب للسمة
    | بشيء أكثر وضوحًا للقارئ مثل "عنوان البريد الإلكتروني" بدلاً من
    | "البريد الإلكتروني". هذا يساعدنا ببساطة في جعل رسالتنا أكثر تعبيرًا.
    |
    */
