            ...
            <div class="container">
                ...
                <div class="tab-content" id="myTabContent">
                                ...
                                <form id="patientForm" enctype="multipart/form-data">
                                    ...
                                    @foreach ([
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="{{ $field }}">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="disability_type_id">
                                                <i class="bi bi-pencil-square"></i>
                                            </button>
                                        </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="disability_cause_id">
                                                <i class="bi bi-pencil-square"></i>
                                            </button>
                                        </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="disabled_person_residence">
                                                <i class="bi bi-pencil-square"></i>
                                            </button>
                                        </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="toilet_facilities">
                                                <i class="bi bi-pencil-square"></i>
                                            </button>
                                        </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="education_type">
                                                <i class="bi bi-pencil-square"></i>
                                            </button>
                                        </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="employment_status">
                                                <i class="bi bi-pencil-square"></i>
                                            </button>
                                        </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="employment_type">
                                                <i class="bi bi-pencil-square"></i>
                                            </button>
                                        </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="social_status">
                                                <i class="bi bi-pencil-square"></i>
                                            </button>
                                        </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="vocational_training">
                                                <i class="bi bi-pencil-square"></i>
                                            </button>
                                        </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="social_case_responsible">
                                                <i class="bi bi-pencil-square"></i>
                                            </button>
                                        </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="disability_union_responsible">
                                                <i class="bi bi-pencil-square"></i>
                                            </button>
                                        </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="refugee_status">
                                                <i class="bi bi-pencil-square"></i>
                                            </button>
                                        </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="education_status">
                                                <i class="bi bi-pencil-square"></i>
                                            </button>
                                        </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            >
                                            <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="phone_number">
                                                <i class="bi bi-pencil-square"></i>
                                            </button>
                                        </div>
                                    ...
                                    {{--                                    >--}}
                                    {{--                                    <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="fax_number">--}}
                                    {{--                                        <i class="bi bi-pencil-square"></i>--}}
                                    {{--                                    </button>--}}
                                    {{--                                </div>--}}
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            >
                                            <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="unwra_card_number">
                                                <i class="bi bi-pencil-square"></i>
                                            </button>
                                        </div>
                    ...
                    <div class="tab-pane fade" id="father" role="tabpanel">
                        <h1>تحديث بيانات الأب</h1>

                        @php
                            $family = $patient->mother->family;
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="health_status" data-target="family">
                                    <i class="bi bi-pencil-square"></i>
                                </button>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="academic_level" data-target="family">
                                    <i class="bi bi-pencil-square"></i>
                                </button>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="profession" data-target="family">
                                    <i class="bi bi-pencil-square"></i>
                                </button>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="has_disabilities" data-target="family">
                                    <i class="bi bi-pencil-square"></i>
                                </button>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="disability_family" data-target="family">
                                    <i class="bi bi-pencil-square"></i>
                                </button>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="family_type" data-target="family">
                                    <i class="bi bi-pencil-square"></i>
                                </button>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="has_health_insurance" data-target="family">
                                    <i class="bi bi-pencil-square"></i>
                                </button>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="health_insurance_reason" data-target="family">
                                    <i class="bi bi-pencil-square"></i>
                                </button>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="has_rehabilitation_centers" data-target="family">
                                    <i class="bi bi-pencil-square"></i>
                                </button>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="healthy_adults_count" data-target="family">
                                    <i class="bi bi-pencil-square"></i>
                                </button>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="annual_income" data-target="family">
                                    <i class="bi bi-pencil-square"></i>
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="mother" role="tabpanel">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="name" data-target="mother">
                                    <i class="bi bi-pencil-square"></i>
                                </button>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="birth_date" data-target="mother">
                                    <i class="bi bi-pencil-square"></i>
                                </button>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="health_status" data-target="mother">
                                    <i class="bi bi-pencil-square"></i>
                                </button>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="academic_level" data-target="mother">
                                    <i class="bi bi-pencil-square"></i>
                                </button>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="profession" data-target="mother">
                                    <i class="bi bi-pencil-square"></i>
                                </button>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="marriages_count" data-target="mother">
                                    <i class="bi bi-pencil-square"></i>
                                </button>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="relationship_with_father" data-target="mother">
                                    <i class="bi bi-pencil-square"></i>
                                </button>
                            </div>
                        ...
                        @foreach($pregnancy_questions as $field => $label)
                            <div class="mb-4">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="{{ $field }}" data-target="mother">
                                        <i class="bi bi-pencil-square"></i>
                                    </button>
                                </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <button type="button" class="btn btn-sm btn-light edit-btn ms-2" data-field="has_disabilities" data-target="mother">
                                    <i class="bi bi-pencil-square"></i>
                                </button>
                            </div>
                    ...
                    <div class="tab-pane fade" id="effect" role="tabpanel">
                        ...
                        @if ($patient->effect)
                            ...
                            @endforeach
                        @else
                            @include('effect.effect', ['grades' => $grades])
                        @endif
                    </div>

                    {{--member--}}
                    <div class="tab-pane fade" id="family" role="tabpanel">
                        <h1>تحديث أفراد العائلة</h1>
    ...
    <script>
        $(document).ready(function() {
            $('.edit-btn').on('click', function() {
                ...
                // إخفاء النص وإظهار الإدخال وتركيز الإدخال
                $('#' + field + '_text').addClass('d-none');
                $('#' + field + '_input').removeClass('d-none').focus();

                // إزالة أحداث blur السابقة ثم إضافة حدث blur جديد
                $('#' + field + '_input').off('blur').on('blur', function() {
                    ...
                    // طلب Ajax لتحديث الحقل
                    $.ajax({
                        url: '{{ route("patient.updateField", $patient->id) }}',
                        method: 'POST',
                        data: formData,
                        processData: false,
                        contentType: false,
                        success: function(response) {
                            if (response.success) {
                                if (field === 'disability_type_id' || field === 'disability_cause_id') {
                                    // عرض النص المختار من القائمة
                                    $('#' + field + '_text').text($('#' + field + '_input option:selected').text());
                                } else if (['vocational_training', 'social_case_responsible', 'disability_union_responsible', 'refugee_status', 'education_status'].includes(field)) {
                                    // عرض نعم أو لا بدل الرقم 1 أو 0
                                    $('#' + field + '_text').text(newValue == 1 ? 'نعم' : 'لا');
                                } else {
                                    // عرض القيمة النصية مباشرة
                                    $('#' + field + '_text').text(newValue);
                                }

                                // إظهار النص وإخفاء الإدخال
                                $('#' + field + '_text').removeClass('d-none');
...
@push('js')
    <script>
        $(function () {
            ...
            // يستمع فقط للأزرار التي تخص العائلة (target = family)
            $(document).on('click', '.edit-btn[data-target="family"]', function () {
                ...
                input.off('blur').on('blur', function () {
                    ...
                    $.post({
                        url : '{{ route("family.updateField", $family->id) }}',
                        data: {
                            _token: '{{ csrf_token() }}',
                            field : field,
                            value : value
                        ...
                        success: res => {
                            span.text(render(field, value, input)).removeClass('d-none');
                            input.addClass('d-none');
                        },
                        error: xhr => {
                            if (xhr.status === 422) {
                                const msg = xhr.responseJSON.errors[field]?.[0] ?? 'خطأ غير معروف';
                                errBox.text(msg);
                            } else {
            ...
            function getVal($el) {
                return $el.is('select') ? $el.val() : $el.val().trim();
            }

            function render(field, val, $input) {
                const bools = [
                    'has_disabilities',
                    'disability_family',
                ...
                return $input.is('select') ? $input.find('option:selected').text() : val;
            }
        });
    </script>
@endpush
...
@push('js')
    <script>
        $(function () {
            ...
            // التعامل فقط مع الأزرار التي تحمل data-target="mother"
            $(document).on('click', '.edit-btn[data-target="mother"]', function () {

                const field  = $(this).data('field'),
                    span   = $('#' + 'mother_' + field + '_text'),
                    input  = $('#' + 'mother_' + field + '_input'),
                    errBox = $('#' + 'mother_' + field + '_error');
                ...
                input.off('blur').on('blur', function () {
                    ...
                    // قيم خاصة بالselect أو input نصي/رقمي/تاريخ
                    if (input.is('select')) {
                        value = input.val();
                    } else {
                    ...
                    $.post({
                        url : '{{ route("mother.updateField", $patient->mother->id) }}',
                        data: {
                            _token: '{{ csrf_token() }}',
                            field : field,
                            value : value
                        ...
                        success: res => {
                            ...
                            if (bools.includes(field)) {
                                span.text(value == 1 ? 'نعم' : 'لا');
                            } else {
                                // لو select ارجع نص الخيار المختار، وإلا القيمة مباشرة
                                span.text(input.is('select') ? input.find('option:selected').text() : value);
                            }
